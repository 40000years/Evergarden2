...
![Block preview generated from the SkyWhale blueprint](previews/sky-whale-block-preview.png)

This is an orthographic render of the 10,761 block positions returned by `SkyWhale.blockAt`, not a Minecraft client screenshot. The sky and clouds are illustrative.
